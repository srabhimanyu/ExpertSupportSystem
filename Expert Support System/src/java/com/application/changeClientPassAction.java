...
public class changeClientPassAction extends ActionSupport implements ServletRequestAware, SessionAware {
    ...
    public String execute() throws Exception {
        ...
        ClientDetails cd = (ClientDetails) s.get(ClientDetails.class, clientId);
                if(cd.getPasswd().equals(oldpassword)) {
